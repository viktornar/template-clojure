(ns hooks.beesbuddy.models.interface
  (:require [clj-kondo.hooks-api :as hooks]))

(defn define-hydration-method
  "This is used for both [[beesbuddy.models.interface/define-simple-hydration-method]] and
  for [[beesbuddy.models.interface/define-batched-hydration-method]]."
