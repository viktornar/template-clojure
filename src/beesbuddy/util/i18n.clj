(ns beesbuddy.util.i18n
  "i18n functionality."
  (:require
   [cheshire.generate :as json.generate]
   [clojure.string :as str]
   [clojure.walk :as walk]
   [beesbuddy.util.i18n.impl :as i18n.impl]
...
(defn site-locale-string
  "The default locale string for this beesbuddy installation. Normally this is the value of the `site-locale` Setting,
...
(defn site-locale
  "The default locale for this beesbuddy installation. Normally this is the value of the `site-locale` Setting."
  ^Locale []
...
(defn available-locales-with-names
  ...
  (for [locale-name (i18n.impl/available-locale-names)]
    ...
    ;; because the locale is normalized before saving (beesbuddy#15657, beesbuddy#16654)
