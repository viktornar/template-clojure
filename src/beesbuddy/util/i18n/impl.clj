(ns beesbuddy.util.i18n.impl
  "Lower-level implementation functions for `beesbuddy.util.i18n`. Most of this is not meant to be used directly; use the
  functions and macros in `beesbuddy.util.i18n` instead."
  (:require
   [clojure.java.io :as io]
   [clojure.string :as str]
   [clojure.tools.reader.edn :as edn]
   [beesbuddy.plugins.classloader :as classloader]
   [beesbuddy.util.i18n.plural :as i18n.plural]
...
(defn- locale-edn-resource
  ...
  scripts in `bin/i18n` from `.po` files from POEditor.
    ...
    (locale-edn-resources \"es\") ;-> #object[java.net.URL \"file:/home/cam/beesbuddy/resources/beesbuddy/es.edn\"]"
...
(defn translate
  ...
  `./resources/beesbuddy/beesbuddy/Messages_<locale>.class`. Attempts to translate with `language-country` Locale if
...
(defn site-locale-from-setting
  ...
  []
  (when-let [get-value-of-type (resolve 'beesbuddy.models.setting/get-value-of-type)]
