...
;; beesbuddy/beesbuddy/log4j2.xml and refer to it that way so presumably no jar could add another log4j2.xml that we
...
(defn -main
  "Main entrypoint. Invokes [[beesbuddy.core/entrypoint]]"
  [& args]
  (apply (requiring-resolve 'beesbuddy.core/entrypoint) args))