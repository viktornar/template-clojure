(ns beesbuddy.driver.sql-jdbc
  ...
  (:require
   ...
   [beesbuddy.driver.sql-jdbc.actions :as sql-jdbc.actions]
   ...
   [beesbuddy.query-processor.writeback :as qp.writeback]
...
;;; +----------------------------------------------------------------------------------------------------------------+
;;; |                                     Default SQL JDBC beesbuddy.driver impls                                     |
;;; +----------------------------------------------------------------------------------------------------------------+
...
(defmethod driver/db-default-timezone :sql-jdbc
  ...
  (if (has-method? driver sql-jdbc.sync/db-default-timezone)
    ...
    ((get-method driver/db-default-timezone :beesbuddy.driver/driver) driver database)))
