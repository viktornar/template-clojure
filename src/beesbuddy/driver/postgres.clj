(ns beesbuddy.driver.postgres
  ...
  (:require
   ...
   [beesbuddy.driver.postgres.actions :as postgres.actions]
   [beesbuddy.driver.postgres.ddl :as postgres.ddl]
   [beesbuddy.driver.sql :as driver.sql]
   ...
   [beesbuddy.driver.sql-jdbc.sync.describe-database :as sql-jdbc.describe-database]
   ...
   [beesbuddy.lib.schema.temporal-bucketing
    :as lib.schema.temporal-bucketing]
   [beesbuddy.models.secret :as secret]
...
(defmethod sql.qp/date [:postgres :day-of-week]
  ...
  ;;
  ;; Since that's different than what we normally consider the [[beesbuddy.driver/db-start-of-week]] for Postgres
