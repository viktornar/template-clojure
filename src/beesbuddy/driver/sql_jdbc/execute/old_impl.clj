(ns beesbuddy.driver.sql-jdbc.execute.old-impl
  "Old implementations of [[beesbuddy.driver.sql-jdbc.execute]] methods. All methods and functions in this namespace
...
(defmulti connection-with-timezone
  "Deprecated in beesbuddy 47. Implement [[beesbuddy.driver.sql-jdbc.execute/do-with-connection-with-options]] instead.
  This method will be removed in or after beesbuddy 50."
...
(defmulti set-timezone-sql
  ...
  of [[beesbuddy.driver.sql-jdbc.execute/do-with-connection-with-options]]; it should be considered deprecated in
  favor of implementing [[beesbuddy.driver.sql-jdbc.execute/do-with-connection-with-options]] directly."
